 ...
 * ```
 */
export const existingUser = new PreparedQuery<
  IExistingUserParams,
  IExistingUserResult
>(existingUserIR);
 ...
 * ```
 */
export const createUserRequest = new PreparedQuery<
  ICreateUserRequestParams,
  ICreateUserRequestResult
>(createUserRequestIR);
